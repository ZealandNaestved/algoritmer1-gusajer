...
public class Data {
    ...
    // private array med tal mellem 1000
    private int[] randomNumbers10= {5, 0, 1, 9, 4, 8, 6, 6, 2, 5};
    // private array med tal mellem 10
    ...
    // private array med drenge navne
    ...
    private static void randomNumbers(int n, int max) {
        System.out.print("{");
        // uendelight for loop til at lave random numbers
        for (int i = 0; i < n-1; i++) {
